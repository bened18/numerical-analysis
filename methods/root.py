...
if T <= 0:
    print("must enter a valid tolerance")
  ...
  expre = input(
    print("Ingrese su funcion sin omitir los signos aritmeticos, en función a X : ")
    ...
    expre2 = input(
      print("Ingrese la derivada de la funcion sin omitir los signos aritmeticos, en función a X : ");
      ...
      expre3 = input(
        print("Ingrese la segunda derivada de la funcion sin omitir los signos aritmeticos, en función a X : ")
